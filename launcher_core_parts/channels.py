...
CHANNEL_TEMPLATES: list[tuple[str, str, str, dict[str, object]]] = [
    ...
    ("minimax-anth", "MiniMax (Anthropic 路径)", "native_claude", {"apibase": "https://api.minimaxi.com/anthropic", "model": "MiniMax-M3"}),
    ...
    ("minimax-oai", "MiniMax (OAI 路径)", "native_oai", {"apibase": "https://api.minimaxi.com/v1", "model": "MiniMax-M3", "context_win": 50000}),
